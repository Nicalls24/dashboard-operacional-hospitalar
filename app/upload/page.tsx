...
export default function UploadPage() {
  ...
  async function handleUpload() {
    ...
    try {
      ...
      setStatus("erro");
      setMensagem(`❌ Erro de conexão: ${String(err)}`);
    }
  }
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <h1 style={{ color: "#f1f5f9", fontSize: 22, margin: 0 }}>
            Hapvida Dashboard
          </h1>
        ...
        <div
          ...
          style={{
            border: `2px dashed ${arquivo ? "#22c55e" : "#334155"}`,
            borderRadius: 12, padding: 32, textAlign: "center",
            cursor: "pointer", marginBottom: 20,
            background: arquivo ? "rgba(34,197,94,0.05)" : "transparent",
            transition: "all 0.2s"
          }}
        >
          <input
        ...
        <button
          ...
          style={{
            ...
            background: status === "loading" ? "#334155" : "#3b82f6",
